...
class KickProjectsControllerTest < ActionController::TestCase
  ...
  test "should create kick_project" do
    assert_difference('KickProject.count') do
      post :create, kick_project: { expiration_date: @kick_project.expiration_date, id: @kick_project.id, kick_category_id: @kick_project.kick_category_id, name: @kick_project.name, picture_link: @kick_project.picture_link, project_link: @kick_project.project_link, status_id: @kick_project.status_id, video_link: @kick_project.video_link }
    end
  ...
  test "should update kick_project" do
    put :update, id: @kick_project, kick_project: { expiration_date: @kick_project.expiration_date, id: @kick_project.id, kick_category_id: @kick_project.kick_category_id, name: @kick_project.name, picture_link: @kick_project.picture_link, project_link: @kick_project.project_link, status_id: @kick_project.status_id, video_link: @kick_project.video_link }
    assert_redirected_to kick_project_path(assigns(:kick_project))
  end
