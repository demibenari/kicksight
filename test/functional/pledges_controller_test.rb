...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { delivery_date: @pledge.delivery_date, description: @pledge.description, id: @pledge.id, kick_project_id: @pledge.kick_project_id, min_amount: @pledge.min_amount }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { delivery_date: @pledge.delivery_date, description: @pledge.description, id: @pledge.id, kick_project_id: @pledge.kick_project_id, min_amount: @pledge.min_amount }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
