...
p = Project.create(goal: 17490, start_date: '19.08.2013', expiration_date: '23.09.2013', kick_id: 'aharburg/gregorian-chant-modes-album', name: 'Gregorian Chant Modes Album', description: 'An album featuring an interpretation of the 8 Roman chant modes for those new to Chant.', project_link: 'http://www.kickstarter.com/projects/aharburg/gregorian-chant-modes-album', picture_link: 'https://s3.amazonaws.com/ksr/projects/590648/photo-main.jpg', video_link: 'https://d2pq0u4uni88oo.cloudfront.net/projects/590648/video-279450-h264_high.mp4', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 3, amount_pledged: 70)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 10, amount_pledged: 330)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 18, amount_pledged: 590)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 45, amount_pledged: 1407)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 53, amount_pledged: 1647)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(28).id, amount_backers: 0, amount_pledged: 0)




p = Project.create(goal: 10000, start_date: '19.08.2013', expiration_date: '16.09.2013', kick_id: '654131116/frederic-records-his-debut-album-and-films-music-v', name: 'Frederic Records His Debut Album & Films Music Video!!', description: 'Following my demo, this is my first album & music video! It isn''t possible without your help so thank you so much for your support!', project_link: 'http://www.kickstarter.com/projects/654131116/frederic-records-his-debut-album-and-films-music-v', picture_link: 'https://s3.amazonaws.com/ksr/projects/648984/photo-main.jpg', video_link: 'https://d2pq0u4uni88oo.cloudfront.net/projects/648984/video-279082-h264_high.mp4', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 1, amount_pledged: 15)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 5, amount_pledged: 145)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 8, amount_pledged: 473)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 9, amount_pledged: 632)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 9, amount_pledged: 632)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 3, amount_pledged: 134)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 15, amount_pledged: 740)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 18, amount_pledged: 805)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 3, amount_pledged: 74)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 10, amount_pledged: 436)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 11, amount_pledged: 450)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(12).id, amount_backers: 2, amount_pledged: 70)
Daily.create(project_id: p.id, push_date_id: PushDate.find(13).id, amount_backers: 10, amount_pledged: 470)
Daily.create(project_id: p.id, push_date_id: PushDate.find(14).id, amount_backers: 23, amount_pledged: 1015)
Daily.create(project_id: p.id, push_date_id: PushDate.find(15).id, amount_backers: 42, amount_pledged: 1463)
Daily.create(project_id: p.id, push_date_id: PushDate.find(16).id, amount_backers: 60, amount_pledged: 2317)
Daily.create(project_id: p.id, push_date_id: PushDate.find(17).id, amount_backers: 75, amount_pledged: 2947)
Daily.create(project_id: p.id, push_date_id: PushDate.find(18).id, amount_backers: 104, amount_pledged: 3713)
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 113, amount_pledged: 4036)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 129, amount_pledged: 6347)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 139, amount_pledged: 9874)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 148, amount_pledged: 12605)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 149, amount_pledged: 12864)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
p = Project.create(goal: 115000, start_date: '20.09.2013', expiration_date: '19.09.2013', kick_id: 'u55/u55-end-of-the-line', name: 'U55 - END OF THE LINE', description: 'Deeply embedded in H.P. Lovecrafts mythology, U55 – END OF THE LINE is an innovative horror game set in modern-day Berlin.', project_link: 'http://www.kickstarter.com/projects/u55/u55-end-of-the-line', picture_link: 'https://s3.amazonaws.com/ksr/projects/649035/photo-main.jpg', video_link: 'https://www.youtube.com/watch?v=muSjOGxBJOg', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 14, amount_pledged: 985)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 97, amount_pledged: 4567)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 221, amount_pledged: 10415)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 296, amount_pledged: 23075)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 1, amount_pledged: 15)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 4, amount_pledged: 43)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 5, amount_pledged: 94)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 10, amount_pledged: 176)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 26, amount_pledged: 5392)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
p = Project.create(goal: 125000, start_date: '19.08.2013', expiration_date: '18.09.2013', kick_id: 'ronimo/awesomenauts-starstorm', name: 'Awesomenauts: Starstorm', description: 'We want to take Awesomenauts to the next level, with characters, features, a new map, and more! Join us to make this happen!', project_link: 'http://www.kickstarter.com/projects/ronimo/awesomenauts-starstorm', picture_link: 'https://s3.amazonaws.com/ksr/projects/595650/photo-main.jpg', video_link: 'https://d2pq0u4uni88oo.cloudfront.net/projects/595650/video-280570-h264_high.mp4', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 126, amount_pledged: 5437)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 657, amount_pledged: 24679)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 947, amount_pledged: 47679)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 1562, amount_pledged: 82990)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 1862, amount_pledged: 97521)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(5).id, amount_backers: 2, amount_pledged: 15)
Daily.create(project_id: p.id, push_date_id: PushDate.find(6).id, amount_backers: 18, amount_pledged: 94)
Daily.create(project_id: p.id, push_date_id: PushDate.find(7).id, amount_backers: 47, amount_pledged: 256)
Daily.create(project_id: p.id, push_date_id: PushDate.find(8).id, amount_backers: 52, amount_pledged: 400)
Daily.create(project_id: p.id, push_date_id: PushDate.find(9).id, amount_backers: 60, amount_pledged: 509)
Daily.create(project_id: p.id, push_date_id: PushDate.find(10).id, amount_backers: 71, amount_pledged: 734)
Daily.create(project_id: p.id, push_date_id: PushDate.find(11).id, amount_backers: 85, amount_pledged: 806)
Daily.create(project_id: p.id, push_date_id: PushDate.find(12).id, amount_backers: 87, amount_pledged: 1258)
Daily.create(project_id: p.id, push_date_id: PushDate.find(13).id, amount_backers: 89, amount_pledged: 1434)
Daily.create(project_id: p.id, push_date_id: PushDate.find(14).id, amount_backers: 99, amount_pledged: 1945)
Daily.create(project_id: p.id, push_date_id: PushDate.find(15).id, amount_backers: 101, amount_pledged: 2431)
Daily.create(project_id: p.id, push_date_id: PushDate.find(16).id, amount_backers: 117, amount_pledged: 2945)
Daily.create(project_id: p.id, push_date_id: PushDate.find(17).id, amount_backers: 124, amount_pledged: 3015)
Daily.create(project_id: p.id, push_date_id: PushDate.find(18).id, amount_backers: 135, amount_pledged: 3415)
Daily.create(project_id: p.id, push_date_id: PushDate.find(19).id, amount_backers: 140, amount_pledged: 3947)
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 159, amount_pledged: 4319)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 162, amount_pledged: 4579)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 170, amount_pledged: 4663)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 172, amount_pledged: 7435)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
p = Project.create(goal: 15000, start_date: '20.09.2013', expiration_date: '19.10.2013', kick_id: '1016239196/avenue-of-the-strongest', name: 'AVENUE OF THE STRONGEST', description: 'Witness 9/11 through the lens of the closest surviving photographer, Mark Roddenberry.', project_link: 'http://www.kickstarter.com/projects/1016239196/avenue-of-the-strongest', picture_link: 'https://s3.amazonaws.com/ksr/projects/613265/photo-main.jpg', video_link: 'https://www.youtube.com/watch?v=X7wNTnomZGA', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 2, amount_pledged: 19)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 7, amount_pledged: 478)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 10, amount_pledged: 512)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 11, amount_pledged: 591)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
p = Project.create(goal: 6000, start_date: '20.09.2013', expiration_date: '19.10.2013', kick_id: 'michaelfriberg/by-the-olive-trees-stories-of-syrian-refugees', name: '"By the Olive Trees": Stories of Syrian Refugees', description: '"By the Olive Trees" is a 64-page color newsprint publication consisting of stories from those affected by the Syrian civil war.', project_link: 'http://www.kickstarter.com/projects/michaelfriberg/by-the-olive-trees-stories-of-syrian-refugees', picture_link: 'https://s3.amazonaws.com/ksr/projects/641252/photo-main.jpg', video_link: 'https://d2pq0u4uni88oo.cloudfront.net/projects/641252/video-280753-h264_high.mp4', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 7, amount_pledged: 247)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 42, amount_pledged: 2479)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 77, amount_pledged: 3459)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 93, amount_pledged: 3868)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
...
p = Project.create(goal: 25000, start_date: '20.09.2013', expiration_date: '19.10.2013', kick_id: '1294097730/tennessee-river-sparkling-gem-of-the-south', name: 'Tennessee River: Sparkling Gem of the South', description: 'Photographer/pilot, Ron Lowery uses his aerial artistry to connect us all environmentally and emotionally to the Tennessee River', project_link: 'http://www.kickstarter.com/projects/1294097730/tennessee-river-sparkling-gem-of-the-south', picture_link: 'https://s3.amazonaws.com/ksr/projects/634130/photo-main.jpg', video_link: 'https://d2pq0u4uni88oo.cloudfront.net/projects/634130/video-278796-h264_high.mp4', category_id: c.id, status_id: s.id)
...
Daily.create(project_id: p.id, push_date_id: PushDate.find(20).id, amount_backers: 2, amount_pledged: 75)
Daily.create(project_id: p.id, push_date_id: PushDate.find(21).id, amount_backers: 10, amount_pledged: 277)
Daily.create(project_id: p.id, push_date_id: PushDate.find(22).id, amount_backers: 20, amount_pledged: 948)
Daily.create(project_id: p.id, push_date_id: PushDate.find(23).id, amount_backers: 27, amount_pledged: 1430)
Daily.create(project_id: p.id, push_date_id: PushDate.find(24).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(25).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(26).id, amount_backers: 0, amount_pledged: 0)
Daily.create(project_id: p.id, push_date_id: PushDate.find(27).id, amount_backers: 0, amount_pledged: 0)
